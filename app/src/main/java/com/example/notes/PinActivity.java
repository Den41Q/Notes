...
public class PinActivity extends AppCompatActivity {
    ...
    public void inputPin() {
        ...
        btnClear.setOnClickListener(v -> {
            if (pin.length() != 0) {
                if (pin.length() == 3) {
                    ovalThree.setBackgroundResource(R.drawable.oval_gray);
                } else if (pin.length() == 2) {
                    ovalTwo.setBackgroundResource(R.drawable.oval_gray);
                } else if (pin.length() == 1) {
                    ovalOne.setBackgroundResource(R.drawable.oval_gray);
                }
    ...
    public void changeColorOval() {
        ...
        if (pin.length() == 1) {
            ovalOne.setBackgroundResource(R.drawable.oval_yellow);
        } else if (pin.length() == 2) {
            ovalTwo.setBackgroundResource(R.drawable.oval_yellow);
        } else if (pin.length() == 3) {
            ovalThree.setBackgroundResource(R.drawable.oval_yellow);
        } else if (pin.length() == 4) {
            ovalFour.setBackgroundResource(R.drawable.oval_yellow);
        }
    }
    ...
    public void clearColorOval() {
        ...
        ovalTwo.setBackgroundResource(R.drawable.oval_gray);
        ovalThree.setBackgroundResource(R.drawable.oval_gray);
        ovalFour.setBackgroundResource(R.drawable.oval_gray);
    }
}